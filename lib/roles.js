...
// Role yang dianggap "admin" untuk fitur sensitif seperti Kelola Akun Staf
// (reset password akun orang lain). Sengaja dibatasi ke pucuk pimpinan desa
// saja, bukan semua staf yang bisa login ke dashboard.
export const ROLE_ADMIN = ["kepala_desa", "sekretaris_desa"];
