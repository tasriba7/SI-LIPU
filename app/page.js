...
const LAYANAN = [
  {
    ...
    deskripsi:
      "Surat domisili, SKTM, pengantar KTP/KK, dan lainnya — isi form, dapat kode tracking.",
    icon: IconMail,
    href: "/layanan/surat",
  },
  {
    nama: "Pengaduan Warga",
    deskripsi: "Sampaikan aspirasi atau keluhan, ditindaklanjuti langsung oleh perangkat desa.",
    icon: IconMessage,
  },
  {
  ...
  },
  {
    ...
    deskripsi: "Rekap data dan statistik penduduk per dusun, disiapkan oleh perangkat desa.",
    icon: IconUsers,
  },
];
